...
$searchsql=$searchsql." `modem_location` like '%".$searchbox."%'   || ";
$searchsql=$searchsql." `modem_ssid`  like '%".$searchbox."%'  || ";
$searchsql=$searchsql." `modem_ip`   like '%".$searchbox."%' || ";
$searchsql=$searchsql." `modem_active`   like '%".$searchbox."%' ";
$searchsql=$searchsql." )  ";
...
$mainsql="SELECT `uid`, `modem_location`, `modem_ssid`, `modem_ip`, `modem_active` FROM `wifi_modem_info` where 1";
...
if($j==4 && $mysqlrow[$j]=="0"){$mysqlrow[$j]="NOT Installed";}
if($j==4 && $mysqlrow[$j]=="1"){$mysqlrow[$j]="Installed";}
print "\"".$mysqlrow[$j]."\"";
}
