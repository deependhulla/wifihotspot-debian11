...
#$macAddr="38:EA:A7:0A:83:76";
#$macAddr="80:D2:1D:48:7A:F3";
#$macAddr="80:D2:1D:1A:70:FF";
#$macAddr="C8:AE:9C:0C:C0:77";
#$macAddr="44:91:DB:12:5E:2F";
#$macAddr="80:D2:1D:48:36:DD";
if($macAddr =="")
{
## FACKMAC of google chrome cast#
#$macAddr="44:91:DB:12:5E:2F";
#$macAddr="00:EE:BD:78:0C:A2";
}
...
$todaycodedisplay=$mysqlrow['user_todaycode_active'];
}
}
...
#$urlx="http://192.168.3.254/clubmaster/sendsmsapi.php?smsuser=club&smsapikey=apikeynvm&mobileno=".$gotmobile."&smsmsg=".$smstextmsg."";
$urlxdata=file_get_contents($urlx);
#print "--> $urlxdata";
#$zurlx="http://192.168.3.254/clubmaster/sms-process-trans.php";
#$zurlxdata=file_get_contents($zurlx);
...
<html lang="en">
  ...
  <body>
    <div class="container">
<div align=center>    <img src="<?php echo $companylogo; ?>" align=center height=80px></div>
<?php
...
#print " DXX $dxxx $gotmobblock==0 && $gotmacblock==0 && $timeok==1 ";
