...
$userpacket=0;
$userbytes=0;
$cmdzz="/sbin/iptables -Z M-".$usermacx." 1"; print "\n $cmdzz \n";$cmdzzzz=`$cmdzz`;
$cmdzz="/sbin/iptables -Z M-".$usermacx." 2"; print "\n $cmdzz \n";$cmdzzzz=`$cmdzz`;
$cmdzz="/sbin/iptables -Z M-".$usermacx." 3"; print "\n $cmdzz \n";$cmdzzzz=`$cmdzz`;
$cmdzz="/sbin/iptables -Z M-".$usermacx." 4"; print "\n $cmdzz \n";$cmdzzzz=`$cmdzz`;
