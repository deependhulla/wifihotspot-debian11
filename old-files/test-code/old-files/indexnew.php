...
$urlx="http://127.0.0.1/clubmaster/sendsmsapi.php?smsuser=club&smsapikey=apikeynvm&mobileno=".$gotmobile."&smsmsg=".$smstextmsg."";
$urlxdata=file_get_contents($urlx);
$zurlx="http://127.0.0.1/clubmaster/sms-process-trans.php";
