...
<html lang="en">
  ...
  <body>
    <div class="container">
<div align=center>    <img src="<?=$companylogo?>" align=center height=150 width=300></div>
<?php
...
{
?>
<input type="text" name="pvalue1" class="form-control" value="<?=$pvalue1?>" placeholder="<? echo $pvalue1label; ?>">
<span class="reg_error"><?php echo $error_pvalue1;?></span><br>
<input type="text" name="pvalue2" class="form-control" value="<?=$pvalue2?>" placeholder="<? echo $pvalue2label; ?>">
...
{
?>
<input type="text" name="pvalue3" class="form-control" value="<?=$pvalue3?>" placeholder="<? echo $pvalue3label; ?>">
