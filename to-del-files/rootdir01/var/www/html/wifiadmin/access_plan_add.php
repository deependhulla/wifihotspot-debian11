...
<input type="text"  class="form-control" name="user_access_plan_name" value="<?=$user_access_plan_name?>" required/></div>
...
<!--<div class="row">
<div class="col-md-4">Basic Upload Speed<input type="number"  class="form-control" name="basic_upload_max_speed_kbps"  value="<?=$basic_upload_max_speed_kbps?>"></div>
<div class="col-md-4">Basic Download Speed<input type="number"  class="form-control" name="basic_download_max_speed_kbps" value="<?=$basic_download_max_speed_kbps?>"></div>
<div class="col-md-4">Traffic Limit<input type="number"  class="form-control" name="traffic_limit_in_mb"  value="<?=$traffic_limit_in_mb?>"></div>
</div>-->
<div class="row">
...
?>
<a id="popoverData" class="glyphicon glyphicon-question-sign" href="#" data-content="<? echo $htmltable_days;?>" rel="popover" data-placement="bottom" data-trigger="hover"></a>

<input type="number" class="form-control" name="validity_period_in_mins" value="<?=$validity_period_in_mins?>" pattern="[0-9]" required/></div>
<div class="col-md-6">Traffic Limit For Valid Period in MB (0 Means Unlimited):
<a id="popoverData_mb" class="glyphicon glyphicon-question-sign" href="#" data-content="<? echo $htmltable_mblimit;?>" rel="popover" data-placement="bottom" data-trigger="hover"></a>

<input type="number"  class="form-control" name="traffic_limit_in_mb" value="<?=$traffic_limit_in_mb;?>" pattern="[0-9]" required/></div>
</div>
                            
<div class="row">
<div class="col-md-6">Traffic Reset Limit For Valid Period in Days (0 Means No Cap):<input type="number"  class="form-control" name="traffic_reset_period" value="<?=$traffic_reset_period;?>" pattern="[0-9]" required/></div>
<div class="col-md-6">Traffic Reset Limit in MB (0 Means No Cap):
<a id="popoverData_mb_reset" class="glyphicon glyphicon-question-sign" href="#" data-content="<? echo $htmltable_mblimit;?>" rel="popover" data-placement="bottom" data-trigger="hover"></a>
<input type="number"  class="form-control" name="traffic_reset_limit_in_mb" value="<?=$traffic_reset_limit_in_mb;?>" pattern="[0-9]" required/></div>
</div>
...
?>
<input type="number"  class="form-control" name="basic_upload_max_speed_kbps" value="<?=$upload_kbps_config?>" pattern="[0-9]" required/>
<?
} else {
?>
<input type="number"  class="form-control" name="basic_upload_max_speed_kbps" value="<?=$basic_upload_max_speed_kbps?>" pattern="[0-9]" required/>
<?
}
?>
-->
...
?>
<input type="number"  class="form-control" name="basic_download_max_speed_kbps" value="<?=$download_kbps_config?>" pattern="[0-9]" required/>
<?
} else {
?>
<input type="number"  class="form-control" name="basic_download_max_speed_kbps" value="<?=$basic_download_max_speed_kbps?>" pattern="[0-9]" required/>
<?
}
?>
</div>
...
<div class="row">
<div class="col-md-6">Plan Price In INR (0 Means Free):<input type="number"  class="form-control" name="plan_price" value="<?=$plan_price;?>" pattern="[0-9]" required/></div>
</div>
<div class="col-md-6">Internal Notes:
<textarea class="form-control" rows="10" name="internal_notes" ><?=$internal_notes?></textarea>
</div>
<!--
<div class="row">
<div class="col-md-6">IP-not-allowed:
<label for="user_ip_notallowed_list"></label>
  <textarea class="form-control" name="user_ip_notallowed_list"  value=""rows="5" id="user_ip_notallowed_list"><?=$user_ip_notallowed_list?></textarea>
</div>
  <div class="col-md-6">Special IP List:
  <label for="special_ip_list"></label>
  <textarea class="form-control" name="special_ip_list"  value=""rows="5" id="special_ip_list"><?=$special_ip_list?></textarea>
</div>
</div>
-->
</div>
